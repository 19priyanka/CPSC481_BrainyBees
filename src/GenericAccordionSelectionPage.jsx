...
function GenericSelectionPage({
  ...
  const [accordionCategoriesToDisplay, setAccordionCategoriesToDisplay] =
    useState(accordionCategories);
  ...
  const searchWithinCateogryChange = (event, name) => {
    ...
    if (
      !accordionCategoriesToDisplay.find(
        (c) => c.name === accordionCategory.name
      )
    ) {
      setAccordionCategoriesToDisplay([
        ...accordionCategoriesToDisplay,
        accordionCategory,
      ]);
    }
  };
  ...
  return (
    <div style={{ maxWidth: "150vh" }} className="padding">
      <h1>
        {title}: {language}
      </h1>
            ...
            >
              ...
              <AccordionDetails>
                <div style={{ display: "flex", alignItems: "center" }}>
                  ...
                  {imageOption && x.name === "Loops" && (
                    <img
                      src="https://miro.medium.com/v2/resize:fit:510/0*urnSq8vQ0xujKwid.jpeg"
                      alt="Description"
                ...
                <div style={{ marginBottom: "20px" }}>
                  <TextField
                    ...
                    label="Search"
                    variant="outlined"
                    value={searchWithinCategory[x.name] || ""}
                    onChange={(e) => {
                      searchWithinCateogryChange(e, x.name);
                    }}
                  />
                </div>
